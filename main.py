...
async def handle_start_help(message: Message):
    ...
    welcome_text = (
        ...
        "Всё просто: отправь фото квитанции, и я проверю оплату.\n"
        "После подтверждения оператором ты сразу получишь свою игру! 🚀\n\n"
        "Команды:\n"
        "/start - Начать\n"
...
async def handle_other(message: Message):
    ...
    await message.reply("Пришли мне фото квитанции 🖼")
